...
% Same role/color assignments as esl-crossbar-kcl (blue=input/activation,
% green=analog weight cell, orange=analog current/summation) so a
% \foreach-generated array reads as the same family, not a different figure.
...
\begin{tikzpicture}[
    ...
    vsource/.style={draw=blue!55, circle, line width=0.8pt, fill=blue!18,
                    text=black, minimum size=\cellsize cm, inner sep=0pt,
                    font=\tiny\itshape},
    kclnode/.style={draw, circle, thick, fill=orange!35,
                    minimum size=\cellsize cm, inner sep=0pt, font=\tiny},
    awire/.style={orange!80!black, thick},
    vwire/.style={blue!60!black, thick},
    axislbl/.style={font=\tiny, gray!40!black},
  ]
