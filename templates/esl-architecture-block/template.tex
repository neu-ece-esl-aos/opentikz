...
% Grafted from /home/agent1/pubs/tsarilp-pub/doc/common/tikzsetup.tex (read-only
% reference). Kept as dvipsnames names, matching the source library, rather than
% remapped onto opentikz's five-color otblue/otorange/otteal/otpurple/otgray set
% (see learnings note §"palette collision").
...
\begin{tikzpicture}[
    ...
    core/.style={PE, draw=Aquamarine, fill=Aquamarine!20,
      minimum width=\corewidth, minimum height=\coresize},
    process/.style={draw=NavyBlue, fill=NavyBlue!10, very thick,
    ...
    parameters/.style={chamfered rectangle,
      ...
      draw=ForestGreen, fill=ForestGreen!20, very thick,
      minimum width=0.85*\corewidth, minimum height=0.55*\coresize,
      align=center, font=\scriptsize},
    terminal node/.style={draw=gray, fill=black!10, text=DarkGray, thick,
  ...
  \begin{scope}[on background layer]
    \node[draw=Aquamarine!70!black, dashed, rounded corners=4pt,
      fit margins={left=8pt,right=8pt,top=16pt,bottom=8pt},
      fit=(core1)(acc1)(cfg1)] (tile1) {};
    \node[font=\scriptsize\bfseries, text=Aquamarine!60!black,
  ...
  \node[font=\tiny, text=NavyBlue!70!black, above=6pt of io] {\interbuslabel};
